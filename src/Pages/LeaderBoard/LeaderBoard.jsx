                ...
                <div className="p-6 md:p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-center justify-between">
                                <div className="flex items-center">
                                    <img src="./assets/avater.webp" alt="JE Root" className="object-cover w-10 h-10 rounded-full mr-4" />
                                    <div>
                            ...
                            <li className="flex items-center justify-between">
                                <div className="flex items-center">
                                    <img src="./assets/avater.webp" alt="AN Cook" className="object-cover w-10 h-10 rounded-full mr-4" />
                                    <div>
                            ...
                            <li className="flex items-center justify-between">
                                <div className="flex items-center">
                                    <img src="./assets/avater.webp" alt="KS Williamson" className="object-cover w-10 h-10 rounded-full mr-4" />
                                    <div>
