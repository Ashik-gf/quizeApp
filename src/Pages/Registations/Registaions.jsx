...
import reg2 from '../../assets/Saly-1.png'
import regLogo from '../../assets/logo-white.svg'
    ...
    return (
        <div className="bg-white text-gray-800 ">
            <div className="flex min-h-screen max-h-screen">
                {/* <!-- Left side --> */}
                <div className="  lg:flex lg:w-1/2 bg-primary flex-col justify-between p-12  h-full fixed left-0 top-0">
                    <div className="text-whit">
                        <img src={regLogo} className="h-8" />

                        <img src={reg2} alt="Illustration" className="mx-auto 2xl:ml-0 max-h-64  max-w-lg" />
